...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    private ImageView glasses, hatsCaps, walletBagPurse, shoes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        walletBagPurse = (ImageView) findViewById(R.id.purses_bags_wallets);
        shoes = (ImageView) findViewById(R.id.shoes);
        headPhonesHandFree = (ImageView) findViewById(R.id.headphones_handfree);
        laptop = (ImageView) findViewById(R.id.laptops_pc);
        ...
        walletBagPurse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminCategoryActivity.this, AdminAddNewProductActivity.class);
